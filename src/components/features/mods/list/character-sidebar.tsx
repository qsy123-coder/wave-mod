...
export function CharacterSidebar({
  ...
  return (
    <aside className={cn("flex shrink-0 flex-col gap-2 border-4 border-black bg-[#fff8ef] p-3 shadow-[6px_6px_0px_0px_#000]", className)}>
      {/* 全部 */}
      <Link
        href={allHref}
        className={cn(
          "border-4 border-black px-3 py-2.5 text-xs font-black uppercase tracking-[0.14em] shadow-[4px_4px_0px_0px_#000] transition hover:-translate-y-0.5 hover:shadow-[6px_6px_0px_0px_#000]",
          isAllActive
      ...
      {/* 角色列表 - 隐藏滚动条 */}
      <div className="flex flex-col gap-2 overflow-y-auto scrollbar-hide" style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}>
