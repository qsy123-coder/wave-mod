...
} from "../components/zenless-detail-layout-switch";
  ...
  return (
    <main className="relative -mt-[74px] min-h-screen overflow-hidden bg-[#04070d] text-white">
      ...
      <div className="absolute inset-0">
        ...
        />
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(var(--zzz-overlay-rgb),0.86)_0%,rgba(var(--zzz-overlay-rgb),0.56)_35%,rgba(var(--zzz-overlay-rgb),0.22)_58%,rgba(var(--zzz-overlay-rgb),0.78)_100%)]" />
      ...
      <ZenlessDetailLayoutSwitch
        rightRail={<ZenlessRightRail game={game} mod={mod} />}
      >
        ...
        <section className="grid min-h-[350px] content-end pt-7 lg:max-w-[720px]">
          <MotionReveal delay={0.06} y={24}>
            ...
            <div className="mt-3 flex flex-wrap items-center gap-4 text-sm text-slate-300">
              <span>
                By{" "}
                <strong className="text-white">{mod.character} Creator</strong>
              </span>
        ...
        <ZenlessModDetailTabs
          ...
          description={
            <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
              <div className="border-4 border-black bg-[#07111f]/18 p-4 text-sm font-bold leading-7 text-slate-200 shadow-[5px_5px_0px_0px_#000] ring-1 ring-white/10 backdrop-blur-[2px]">
              ...
              <figure className="hidden items-center justify-center border-4 border-black bg-[#0f172a]/18 p-4 text-center text-slate-100 shadow-[5px_5px_0px_0px_#000] ring-1 ring-white/10 backdrop-blur-[2px] lg:flex">
                <blockquote className="max-w-xs font-serif text-xl italic leading-8">
                  <span className="text-4xl text-white/25">“</span>In the tides
                  of night,
                  <br />
          ...
          installation={
            <section className="border-4 border-black bg-[#07111f]/20 p-4 text-sm font-bold leading-7 text-slate-200 shadow-[5px_5px_0px_0px_#000] ring-1 ring-white/10 backdrop-blur-[2px]">
          ...
          changelog={
            <section className="border-4 border-black bg-[#111827]/20 p-4 text-sm font-bold leading-7 text-slate-100 shadow-[5px_5px_0px_0px_#000] ring-1 ring-white/10 backdrop-blur-[2px]">
