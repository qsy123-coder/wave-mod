  ...
  return (
    <section className="relative z-10 mt-2 grid gap-2 lg:grid-cols-2">
      <MotionReveal delay={0.06} y={20} rotate={-1}>
        <div className="flex min-h-[112px] items-center justify-between gap-4 border-4 border-black bg-[var(--neo-panel)] px-5 py-4 text-black shadow-[6px_6px_0_0_#000]">
      ...
      <MotionReveal delay={0.14} y={20} rotate={1}>
        <div className="flex min-h-[112px] items-center justify-between gap-4 border-4 border-black bg-[var(--neo-muted)] px-5 py-4 text-black shadow-[6px_6px_0_0_#000]">
          <div className="min-w-0">
            <p className="inline-flex max-w-full items-center gap-2 truncate text-base font-black"><Trophy className="size-5 shrink-0" />Share your creations</p>
